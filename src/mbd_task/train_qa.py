...
def main():
    ...
    parser.add_argument("--seed", type=int, default=123) #13 42 and 123
    ...
    if args.lang == "pt":
        ...
        base_path = "data/qa_squad/global_split"
        args.output_dir = args.output_dir or "outputs/pt-roberta-large-qa-123"
    else:
        model_name = "deepset/xlm-roberta-large-squad2"
        base_path = "data/qa_squad_en/global_split"
        args.output_dir = args.output_dir or "outputs/xlm-roberta-large-qa-123"
